...
link "/stylesheets/style" # Link's css
import "/javascripts/main" # Import's Vanilla Js
```
...
```zare filename="index.zare"
as Card import "../components/Card" # Component importing
link "/stylesheets/style.css" # Link's css
import "/javascripts/main.js" # Import's Vanilla Js
