    ...
    program
        ...
        .action(async (projectPath: string) => {
            ...
            try {
                ...
                const pagesDestination = path.resolve(projectDestination, zareConfigurations.pages);
                const staticFilesDestination = path.resolve(projectDestination, zareConfigurations.static)
...
async function fileRoutingHandler(pagesFile: string[], pagesDestination: string, prefix: string = "") {
    const routes: string[] = [];
