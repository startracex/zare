...
describe('Parser', () => {
    ...
    describe("function evaluator", () => {
        ...
        it('should extract function call', () => {
            expect(parser.extractFunctionCallValues("@functionCall('arg1', 'arg2')")).toEqual({ fnName: 'functionCall', fnArgs: ['arg1', 'arg2'] });
        })
    });
    ...
    describe("linkStatic", () => {
        ...
        it("should throw head tag not found error for linking css", () => {
            ...
            try {
                ...
                if (error instanceof Error) expect(error.message).includes(`Head tag is required to link scripts`)
            }
        });
    ...
    describe("use module", () => {
        ...
        it("should throw error of unknown module usage ", () => {
            ...
            try {
                ...
                if (error instanceof Error) expect(error.message).includes(`Unknown module regex`)
            }
    ...
    describe("components", () => {
        ...
        it("should throw unended component error", () => {
            ...
            try {
                ...
                if (error instanceof Error) expect(error.message).includes("Unended component");
            }
        });
